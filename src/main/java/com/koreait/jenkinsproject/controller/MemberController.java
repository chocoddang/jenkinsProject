...
public class MemberController {
	...
	public Map<String, Object> findAllMember(@PathVariable(value="page", required=false) Optional<Integer> opt) {
		...
		return service.findAllMember(page); // findAllMember에 page 전달해야함.
	}
	...
	public Map<String, Object> findMeber(@PathVariable(value="memberNo") Long memberNo) {  // 경로에 변수가 있다 @PathVariable
