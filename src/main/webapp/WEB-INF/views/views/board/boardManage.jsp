...
<script type="text/javascript">
	...
	function fnFileCheck(){
		$('#origin').change(function(){
			let regFile = /(.*)\.(jpe|jpeg|png|gif)$/;
			let maxSize = 1024 * 1024 * 10;  // 최대 10MB
			...
			for (let i = 0; i < files.length; i++) {
				...
				if (fileSize > maxSize) {  // files[i].size : 첨부된 파일 크기
...
<body>
	...
	<div>
		<form id="f">
			...
			첨부 <input type="file" name="origin" id="origin"><br>  <!-- 다중첨부  -->
